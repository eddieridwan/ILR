...
Rails::Initializer.run do |config|
  ...
  # --- This is required for mochahost deployment, where we haven't been able to make use of bundler
  config.gem "sass"
  config.gem "haml"
  ...
  config.action_controller.session = {
    :key => '_ILR_session',
    :secret      => '0cf146185b3b4639a94cb8ef58277a6788e4a43052e57bf0152e3f94c2a8f0e363e46a7932293f8c04fddf16791206828cc5392d823fb77b7c96b6b28929722f'
  }
